...
function m2_default_install() {
   php bin/magento setup:install --backend-frontname="admin" --db-host="127.0.0.1" --db-name="$1" --db-user="root" --db-password="" --base-url="http://projetos.bleez/shopzen2/" --admin-user="admin" --admin-password="mvkPApn4" --admin-email="dev@bleez.com.br" --admin-firstname="admin" --admin-lastname="admin"
}
